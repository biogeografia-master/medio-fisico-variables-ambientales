...
4. Elige un número entero entre el 61 y el 90 (anúncialo en el foro, para evitar duplicidad), para los ejercicios de aleatorización, el cual asignarás al objeto `mi_aleatorizacion`.
